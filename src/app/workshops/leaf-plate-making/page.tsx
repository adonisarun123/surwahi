...
export const metadata = generatePageMetadata(
  ...
  undefined,
  ['Leaf Plate Making', 'Eco Friendly Crafts', 'Sustainable Living Workshop', 'Traditional Crafts India', 'Zero Waste Living']
);
...
export default function LeafPlateMakingPage() {
  return (
    <div className="pt-20">
      ...
      <EventSchema
        name="Leaf Plate Making Workshop"
        description="Learn the traditional, zero-waste craft of stitching plates and bowls from sal and palash leaves with village artisans at Surwahi."
        path="/workshops/leaf-plate-making"
        recurring
      />
