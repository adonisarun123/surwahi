...
export const metadata = generatePageMetadata(
  ...
  undefined,
  ['Bamboo Crafting', 'Lantana Furniture', 'Sustainable Crafts', 'Tribal Art Workshop', 'Eco Friendly Crafts']
);
...
export default function BambooAndLantanaCraftingPage() {
  return (
    <div className="pt-20">
      ...
      <EventSchema
        name="Bamboo & Lantana Crafting Workshop"
        description="Learn to craft baskets, lamps and furniture from bamboo and the invasive lantana weed — a sustainable craft turning ecological problem into livelihood."
        path="/workshops/bamboo-and-lantana-crafting"
        recurring
      />
