      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto prose">
          ...
          <section className="mb-8">
            ...
            <p className="text-body-md mb-4">All bookings are subject to availability and confirmation. By making a reservation, you agree to:</p>
          ...
          <section className="mb-8">
            ...
            <p className="text-body-md mb-4">As a guest, you are responsible for:</p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
