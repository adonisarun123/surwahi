...
export const metadata = generateMetadata({
  title: 'Terms of Service — Surwahi Social Ecoestate',
  description: 'Terms of service for booking and staying at Surwahi Social Ecoestate.',
        ...
        <div className="max-w-4xl mx-auto prose">
          ...
          <section className="mb-8">
            ...
            <p className="text-body-md text-black mb-4">
              By accessing and using Surwahi Social Ecoestate&apos;s website and services, you accept and agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our services.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-body-md text-black mb-4">
              Surwahi Social Ecoestate shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of our services or property. We are not responsible for loss or damage to personal belongings.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-body-md text-black mb-4">
              All content on this website, including text, images, logos, and designs, is the property of Surwahi Social Ecoestate and is protected by copyright and intellectual property laws.
            </p>
          </section>
