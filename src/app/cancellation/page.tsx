...
export const metadata = generateMetadata({
  title: 'Cancellation Policy — Surwahi Social Ecoestate',
  description: 'Cancellation and refund policy for bookings at Surwahi Social Ecoestate.',
        ...
        <div className="max-w-4xl mx-auto prose">
            ...
            <div className="bg-sand-50 p-6 rounded-card mb-4">
              <ul className="list-none space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-black">Full refund minus processing fees</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-moss-500 font-bold min-w-[120px]">15-29 days:</span>
                  <span className="text-black">50% refund of the total booking amount</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-moss-500 font-bold min-w-[120px]">7-14 days:</span>
                  <span className="text-black">25% refund of the total booking amount</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-moss-500 font-bold min-w-[120px]">Less than 7 days:</span>
                  <span className="text-black">No refund</span>
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2 text-black">
              ...
              <li><strong>Phone:</strong> <a href="tel:+917795207779" className="text-moss-500 hover:text-forest-700">+91 77952 07779</a></li>
            </ul>
            <p className="text-body-md text-black mb-4">
