...
export const metadata = generateMetadata({
  title: 'Accessibility Statement — Surwahi Social Ecoestate',
  description: 'Accessibility information and commitment for Surwahi Social Ecoestate.',
        ...
        <div className="max-w-4xl mx-auto prose">
          ...
          <section className="mb-8">
            ...
            <p className="text-body-md text-black mb-4">
              Surwahi Social Ecoestate is committed to ensuring digital accessibility for people with disabilities. We are continually improving the user experience for everyone and applying relevant accessibility standards.
            </p>
          </section>
          ...
          <section className="mb-8 bg-moss-500/10 p-6 rounded-card border-l-4 border-moss-500">
            ...
            <p className="text-body-md text-black">
              Thank you for choosing Surwahi Social Ecoestate. We are committed to providing an inclusive experience for all our guests and website visitors.
            </p>
          </section>
        </div>
      </div>
