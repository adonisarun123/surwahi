...
export const metadata = generatePageMetadata(
    ...
    'Affordable and traditional mud-built cottages perfect for groups and families.',
    '/stay/mudhouses',
    undefined,
    ['Mudhouses Kanha', 'Dormitory Kanha', 'Group Stay Kanha', 'Traditional Cottage', 'Budget Stay']
);

// Filtering for dormitory category as per previous data, but branding as Mudhouses & Dorm
const mudhouses = Object.values(rooms).filter(room => room.category === 'Dormitory');

export default function MudhousesPage() {
    return (
        <div className="pt-20">
            ...
            <section className="bg-sand-50 py-12">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-body-lg text-soil-700 max-w-2xl mx-auto">
                        Experience authentic local living in our traditional mud-built cottages and dormitories.
                    </p>
                </div>
            </section>
            ...
            <section className="py-12">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid md:grid-cols-2 gap-8">
                        {mudhouses.map((room) => (
                            <Link href={`/stay/${room.slug}`} key={room.id} className="group block bg-bone-0 rounded-card overflow-hidden shadow-elev-1 hover:shadow-elev-2 transition-all">
