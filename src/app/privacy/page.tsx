      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto prose">
          ...
          <section className="mb-8">
            ...
            <p className="text-body-md text-black mb-4">We may collect the following types of information:</p>
          ...
          <section className="mb-8">
            ...
            <p className="text-body-md text-black mb-4">We use your information to:</p>
            <ul className="list-disc pl-6 mb-4 space-y-2 text-black">
          ...
          <section className="mb-8">
            ...
            <p className="text-body-md text-black mb-4">You have the right to:</p>
            <ul className="list-disc pl-6 mb-4 space-y-2 text-black">
